...
import kg.zukhridin.nework.adapter.viewholders.downloadAudio
...
class PostDetailFragmentWithAudio : Fragment(), PostMenuOnItemClick {
    @Inject
    ...
    override fun onCreateView(
        ...
        player = CustomMediaPlayer(requireContext(), binding.contentAudio, AttachmentType.AUDIO)
        return binding.root
    }
            ...
            lifecycleScope.launchWhenCreated {
                if (postId != null) {
                    ...
                    binding.itemSettings.setOnClickListener {
                        PostMenu(this@PostDetailFragmentWithAudio, requireContext(), it, post).show()
                    }
